...
<x-section>  
    ...
    <x-slot:titulo>Nuevo Grupo
        <div class="float-end">
            <a class="btn btn-outline-success" href="{{route('grupo.index')}}" role="button">Listado de Grupos</a>
           </div>
    </x-slot>
    ...
    <form method="POST" action="{{ route('grupo.store') }}">
        ...
        <div class="row mb-3">
            <label for="nombre_grupo" class="col-md-4 col-form-label text-md-end">Grupo</label>
    
            <div class="col-md-6">
                <input id="nombre_grupo" type="text" class="form-control @error('nombre_grupo') is-invalid @enderror" name="nombre_grupo" value="{{ old('nombre_grupo') }}" required >
